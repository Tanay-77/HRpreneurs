            ...
            <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
               ...
               <div className="bg-[#F9F9F9] rounded-[24px] p-8 hover:bg-[#DDE5D3]/20 transition-colors duration-500">
                  <div className="relative h-80 w-full rounded-[16px] overflow-hidden mb-8">
                     <Image src="https://i.pinimg.com/736x/67/a8/3f/67a83f5c3a4675510400910d11cd26d9.jpg" alt="Ami Upadhyaya" fill className="object-cover" referrerPolicy="no-referrer" />
                  </div>
               ...
               <div className="bg-[#F9F9F9] rounded-[24px] p-8 hover:bg-[#DDE5D3]/20 transition-colors duration-500">
                  <div className="relative h-80 w-full rounded-[16px] overflow-hidden mb-8">
                     <Image src="https://i.pinimg.com/1200x/af/75/8a/af758a84f45aae4f0ce7a65ee4d3d313.jpg" alt="Rushi Upadhyaya" fill className="object-cover" referrerPolicy="no-referrer" />
                  </div>
